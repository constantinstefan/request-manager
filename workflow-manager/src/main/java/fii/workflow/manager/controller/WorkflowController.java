...
import fii.workflow.manager.domain.*;
import fii.workflow.manager.mapper.WorkflowExecutionContextMapper;
import fii.workflow.manager.dto.*;
import fii.workflow.manager.service.*;
...
public class WorkflowController {
    ...
    ExecutionDto doExecution(@PathVariable Long workflowId,
        ...
        workflowAsyncRunnerService.runWorkflow(workflowId, customer.getCustomerId(), workflowExecutionContext, execution);
